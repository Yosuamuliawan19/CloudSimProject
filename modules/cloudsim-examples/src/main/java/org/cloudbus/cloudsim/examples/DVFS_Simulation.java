...
public class DVFS_Simulation {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            PowerDatacenter datacenter = Helper.createDatacenter(Constants.DATA_CENTER_NAME, Constants.DVFS, 1.0);
            // disables migration for this particular model
